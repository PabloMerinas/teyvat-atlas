...
- **Panel de detalle** por nodo: resumen, explicación, "por qué importa", conexiones
  clicables, tags y distinción entre canon confirmado, interpretación y tema abierto.
- **Buscador**, **filtros** por era/región/tipo y **leyenda visual**.
- **Modo sin spoilers**: selector de progreso que oculta los nodos con spoilers de regiones
  que aún no has jugado.

## Estructura

- `src/data/lore.js` — base de datos de lore: nodos, conexiones, rutas, eras y regiones.
